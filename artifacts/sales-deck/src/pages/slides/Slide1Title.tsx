    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: '#2A2623' }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-between" style={{ padding: '7vh 8vw' }}>
        ...
        <div>
          ...
          <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '6.5vw', fontWeight: 900, color: '#FBF8F4', lineHeight: 1.05, letterSpacing: '-0.02em', textWrap: 'balance', marginBottom: '3vh' }}>
            食品廃棄を、<br />売上に変える
          </h1>
          <p style={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '2vw', fontWeight: 400, color: 'rgba(251,248,244,0.75)', lineHeight: 1.7, maxWidth: '50vw' }}>
