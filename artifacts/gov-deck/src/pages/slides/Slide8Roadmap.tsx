export default function Slide8Roadmap() {
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", backgroundColor: "#FFFFFF", fontFamily: "'Inter', 'Noto Sans JP', sans-serif", position: "relative", boxSizing: "border-box", padding: "5vh 5vw", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "3vh", flex: 1, minHeight: 0 }}>
        <p style={{ fontSize: "1.55vw", fontWeight: 500, color: "#4A5568", lineHeight: 1.5, margin: 0 }}>ご担当者様のご負担を最小限に抑えながら、段階的に連携を深めていきます。</p>
          ...
          <div style={{ flex: 1, backgroundColor: "#0A1628", padding: "3vh 2.5vw", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.8vh" }}>
              <div style={{ display: "flex", gap: "1vw" }}>
                <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1.1vw", color: "#A0AEC0" }}>—</div>
