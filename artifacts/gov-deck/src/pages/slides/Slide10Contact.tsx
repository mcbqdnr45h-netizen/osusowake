    ...
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", backgroundColor: "#0A1628", fontFamily: "'Inter', 'Noto Sans JP', sans-serif", position: "relative", boxSizing: "border-box", padding: "5vh 5vw", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", flex: 1 }}>
        ...
        <div style={{ position: "relative", marginBottom: "5vh" }}>
          ...
          <h2 style={{ fontSize: "5.5vw", fontWeight: 900, color: "#FFFFFF", margin: 0, lineHeight: 1.05, letterSpacing: "-0.04em", position: "relative", zIndex: 1 }}>
            まずはお気軽にご相談ください
          </h2>
        </div>
      ...
      {/* Footer */}
      <div style={{ paddingTop: "2vh", borderTop: "1px solid rgba(255,255,255,0.15)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
