      ...
      <div style={{ display: "flex", gap: "3vw", flex: 1, minHeight: 0 }}>
        <div style={{ flex: 1.1, display: "flex", flexDirection: "column", gap: "2vh" }}>
          ...
          <div style={{ flex: 1, border: "1px solid #E2E8F0", padding: "2.5vh 2vw", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ fontSize: "1.5vw", fontWeight: 700, color: "#0A1628", marginBottom: "1vh" }}>食品ロスの削減の推進に関する法律</div>
          ...
          <div style={{ flex: 1, border: "1px solid #E2E8F0", padding: "2.5vh 2vw", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ fontSize: "1.5vw", fontWeight: 700, color: "#0A1628", marginBottom: "1vh" }}>食品ロス削減 数値目標</div>
          ...
          <div style={{ backgroundColor: "#F7FAFC", border: "1px solid #E2E8F0", padding: "2vh 2vw" }}>
            <p style={{ fontSize: "1.2vw", color: "#4A5568", lineHeight: 1.6, margin: 0 }}>「おすそわけ」の導入は、自治体が策定する食品ロス削減推進計画における<strong style={{ color: "#0A1628" }}>民間連携施策として直接位置づけることができます。</strong></p>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "2vh" }}>
          ...
          <div style={{ flex: 1, backgroundColor: "#0A1628", padding: "2.5vh 2vw", display: "flex", gap: "1.5vw", alignItems: "center" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "3vw", fontWeight: 900, color: "#FFFFFF", minWidth: "4vw" }}>12</div>
            <div>
              <div style={{ fontSize: "1.4vw", fontWeight: 700, color: "#FFFFFF", marginBottom: "0.8vh" }}>つくる責任 つかう責任</div>
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1vw", color: "#A0AEC0", lineHeight: 1.5 }}>目標12.3 — 2030年までに小売・消費段階の食料廃棄を半減</div>
            </div>
          </div>
          <div style={{ flex: 1, border: "1px solid #E2E8F0", padding: "2.5vh 2vw", display: "flex", gap: "1.5vw", alignItems: "center" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "3vw", fontWeight: 900, color: "#0A1628", minWidth: "4vw" }}>11</div>
            <div>
              <div style={{ fontSize: "1.4vw", fontWeight: 700, color: "#0A1628", marginBottom: "0.8vh" }}>住み続けられるまちづくりを</div>
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1vw", color: "#718096", lineHeight: 1.5 }}>地域の飲食店・住民をつなぐプラットフォームとして地域コミュニティを強化</div>
            </div>
          </div>
          <div style={{ flex: 1, border: "1px solid #E2E8F0", padding: "2.5vh 2vw", display: "flex", gap: "1.5vw", alignItems: "center" }}>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "3vw", fontWeight: 900, color: "#0A1628", minWidth: "4vw" }}>17</div>
            <div>
              <div style={{ fontSize: "1.4vw", fontWeight: 700, color: "#0A1628", marginBottom: "0.8vh" }}>パートナーシップで目標を達成しよう</div>
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1vw", color: "#718096", lineHeight: 1.5 }}>自治体・事業者・住民・プラットフォームの四者連携モデル</div>
            </div>
          </div>
        </div>
      </div>
