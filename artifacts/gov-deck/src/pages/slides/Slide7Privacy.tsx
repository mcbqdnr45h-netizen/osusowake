      ...
      <div style={{ display: "flex", gap: "4vw", flex: 1 }}>
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "3vh" }}>
          <p style={{ fontSize: "1.7vw", fontWeight: 500, color: "#4A5568", lineHeight: 1.6, margin: 0 }}>
            公共機関との連携において重要な安全性・セキュリティ・コンプライアンスへの取り組みです。
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5vh" }}>
            <div style={{ display: "flex", gap: "2vw" }}>
              ...
              <div>
                <h3 style={{ fontSize: "1.5vw", fontWeight: 700, color: "#0A1628", margin: "0 0 0.8vh 0" }}>決済セキュリティ（Stripe）</h3>
                <p style={{ fontSize: "1.3vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>国際基準PCI DSS準拠の決済代行会社Stripeを採用。店舗の口座情報・個人情報はStripeが厳重に管理。</p>
              </div>
            </div>
            <div style={{ display: "flex", gap: "2vw" }}>
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1.2vw", color: "#A0AEC0", fontWeight: 600, minWidth: "2vw" }}>02</div>
              <div>
                <h3 style={{ fontSize: "1.5vw", fontWeight: 700, color: "#0A1628", margin: "0 0 0.8vh 0" }}>個人情報保護法への準拠</h3>
                <p style={{ fontSize: "1.3vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>収集するユーザー情報はプライバシーポリシーに基づき適切に管理。第三者提供は行いません。</p>
              </div>
            </div>
            <div style={{ display: "flex", gap: "2vw" }}>
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "1.2vw", color: "#A0AEC0", fontWeight: 600, minWidth: "2vw" }}>03</div>
              <div>
                <h3 style={{ fontSize: "1.5vw", fontWeight: 700, color: "#0A1628", margin: "0 0 0.8vh 0" }}>食品衛生・表示基準の遵守</h3>
                <p style={{ fontSize: "1.3vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>出品できる商品は当日調理・製造品に限定。食品衛生法に基づく飲食店営業許可取得店舗のみ登録可。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "2.5vh" }}>
          <div style={{ backgroundColor: "#F7FAFC", border: "1px solid #E2E8F0", padding: "3.5vh 2.5vw", flex: 1 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2vh" }}>
              <div style={{ borderLeft: "3px solid #0A1628", paddingLeft: "1.5vw" }}>
                ...
                <p style={{ fontSize: "1.1vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>万一の場合は当社サポートが一次対応を担当。店舗との連絡・記録保持を支援。</p>
              </div>
              <div style={{ borderLeft: "3px solid #E2E8F0", paddingLeft: "1.5vw" }}>
                ...
                <p style={{ fontSize: "1.1vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>出品物の審査機能・報告機能を整備。不適切な出品は即時非表示・アカウント停止で対応。</p>
              </div>
              <div style={{ borderLeft: "3px solid #E2E8F0", paddingLeft: "1.5vw" }}>
                <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#0A1628", marginBottom: "0.5vh" }}>行政からの照会対応</div>
                <p style={{ fontSize: "1.1vw", color: "#4A5568", lineHeight: 1.5, margin: 0 }}>自治体担当者からのデータ照会・取引記録の提供に対応する窓口を設置。</p>
              </div>
            </div>
          </div>
        </div>
