...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between whitespace-nowrap rounded-xl border border-input bg-card px-4 py-2.5 text-sm",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      style={{ boxShadow: '0 8px 24px -4px rgba(10,8,6,0.12), 0 3px 6px -3px rgba(10,8,6,0.06), 0 0 0 1px rgba(10,8,6,0.05)' }}
      className={cn(
