...
export function AuthShell({
  ...
  return (
    <div className="min-h-dvh flex flex-col relative overflow-hidden md:overflow-y-auto bg-background">
      ...
      <div className="relative z-10 flex-1 flex flex-col px-6 pt-4 pb-12 max-w-md mx-auto w-full md:flex-none md:my-auto md:max-w-none md:px-16 md:py-20 md:bg-white/75 md:backdrop-blur-xl md:rounded-[2rem] md:border md:border-border/30 md:shadow-2xl">
