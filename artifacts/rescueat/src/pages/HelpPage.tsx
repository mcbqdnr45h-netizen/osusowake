...
const STORE_FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'できます。マイページの「新しい店舗を追加登録する」から追加申請してください。\n\n2店舗目以降は、最初に登録済みのStripe口座（銀行口座・本人確認情報）が自動的に引き継がれます。そのため、追加店舗では営業許可証の提出のみで手続きが完了します。\n\n売上はすべてのお店を合算して同じ口座へ振り込まれます。',
      },
      {
        q: '法人（株式会社・合同会社など）として登録できますか？',
        a: 'できます。口座・本人確認情報の登録画面で「法人」を選択してください。個人事業主との違いは以下の通りです。\n\n【個人事業主】\n・代表者の氏名・住所・生年月日・本人確認書類を提出\n\n【法人】\n・法人名（漢字・カナ・英語）の入力が必要\n・代表者の本人確認書類の提出が必要\n\n個人事業主と法人のどちらも同じ手順で複数店舗の追加が可能です。',
      },
      {
        q: '個人事業主で登録したが、法人に変更したい場合は？',
        a: '決済システム（Stripe）の仕様上、口座登録時に選択した「個人事業主 / 法人」の区分は、後から変更することができません。\n\n変更が必要な場合は、口座の「再連携」が必要です。\n\n【変更手順】\n① 本人確認情報（KYC）の入力画面を開く\n② 画面上部の「事業形態」欄の「口座を再連携して業種を変更する」をタップ\n③ 新しい事業形態（法人）を選択して最初から登録し直す\n\n再連携後は新しい区分でStripeの審査が行われます（通常1〜3営業日）。それまでの間、売上の受け取りは一時的に停止します。\n\n区分の変更が必要かどうかご不明な場合は、LINEサポートにご相談ください。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '口座情報の登録・維持費用は無料です。\n\nお支払い処理手数料（3.6%/件）はOsusowakeのプラットフォーム手数料（25%）とは別に、販売金額から自動的に差し引かれます。どちらも売れた時のみ発生し、固定費は一切かかりません。',
      },
      {
        q: 'アカウントを削除したい場合は？',
