    ...
    items: [
      {
        ...
        a: '口座登録が完了すると、売上からOsusowakeの手数料を差し引いた金額が自動的に登録口座へ振り込まれます。\n\n【振込の仕組み】\n① 決済確定から4営業日後に「振込可能」へ移動します\n② 「振込可能」になった次の月曜日に自動振込されます\n\n例：月曜日に売れた場合 → 金曜日に振込可能 → 翌週月曜日に振込\n例：日曜日に売れた場合 → 木〜金曜日ごろに振込可能 → その翌月曜日に振込\n\n店舗ダッシュボードの「売上残高」では「保留中」「振込可能」の金額をリアルタイムで確認できます。「次回:〇月〇日」は次の月曜スケジュールを示しており、「振込可能」残高がある場合のみその日に振込されます。\n\nスケジュールの変更はできません。詳しくはLINEサポートまでお問い合わせください。',
      },
      {
