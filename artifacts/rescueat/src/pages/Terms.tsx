        ...
        <article>
          ...
          <Section title="第5条の2（料金・手数料）">
            ...
            <ul>
              ...
              <li><strong>表示価格（購入者のお支払い額）</strong>：アプリ上に表示される販売価格は、<strong>サービス手数料 5%（消費税込）を含む税込・サービス料込みの総額</strong> です（10円単位で四捨五入）。購入者は表示された価格をそのままお支払いいただき、追加の料金は一切発生しません。</li>
              <li><strong>プラットフォーム手数料（出品者負担）</strong>：出品者は商品代金（出品者が登録した販売額）の <strong>25%</strong> を当プラットフォーム手数料として運営者に支払うものとします。これとは別に、決済代行事業者所定の決済手数料が出品者の入金額から控除されます。</li>
              <li><strong>月額利用料（出品者負担・将来導入の可能性）</strong>：運営者は、本サービスの安定運営および機能拡充のため、出品者向けに <strong>月額利用料</strong> を新設または改定する場合があります。導入・改定の際は、原則として効力発生日の <strong>30日前まで</strong> に本サービス上の通知または登録メールアドレス宛の連絡により告知します。出品者は、通知後に本サービスの利用を継続することにより、当該料金体系に同意したものとみなされます。</li>
