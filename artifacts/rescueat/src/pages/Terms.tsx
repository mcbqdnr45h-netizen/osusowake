        ...
        <article>
          ...
          <Section title="第1条（定義）">
            ...
            <ul>
              ...
              <li>「出品者」とは、本サービスを通じておすそ分けバッグを販売する飲食店・食料品店等の事業者を指します。</li>
              <li>「おすそ分けバッグ」とは、出品者が廃棄予定の食品をまとめて販売する商品を指します。</li>
              <li>「運営者」とは、本サービスを運営するOsusOwake 事務局を指します。</li>
            </ul>
          </Section>

          <Section title="第2条（サービスの内容）">
            <p>本サービスは、フードロス削減を目的として、飲食店・食料品店等の出品者が余剰食品をおすそ分けバッグとして販売できるプラットフォームを提供します。利用者は本サービスを通じておすそ分けバッグを予約・購入し、指定時間内に店舗で受け取ることができます。</p>
          </Section>
          ...
          <Section title="第5条（購入・キャンセル）">
            <p>おすそ分けバッグの購入確定後のキャンセル・返品は原則としてお受けできません。ただし、出品者の都合により商品提供が不可能となった場合は、全額返金いたします。商品の内容はお楽しみとなるため、内容に関するクレームはお受けできません。</p>
          </Section>

          <Section title="第6条（ノーショーに関する取扱い）">
            <p>利用者が出品者の定める受取時間内に来店せず、おすそ分けバッグを受け取らなかった場合（以下「ノーショー」）、当該商品は出品者の判断により廃棄されることがあります。</p>
          ...
          <Section title="第7条（アレルギー情報および食品衛生に関する免責）">
            <p>本サービスを通じて販売されるおすそ分けバッグに含まれる食品のアレルギー情報、原材料、栄養成分、調理方法、衛生管理等に関する情報の提供および管理は、すべて出品者の責任において行われます。</p>
